...
//yaw轴速度环pid参数
#define YAW_SPEED_PID_KP 3.5f
#define YAW_SPEED_PID_KI 0.0f
#define YAW_SPEED_PID_KD 0.0f

//yaw轴位置环pid参数
#define YAW_POS_PID_KP 18.0f
#define YAW_POS_PID_KI 0.0f
#define YAW_POS_PID_KD 0.0f

  
//pitch轴力矩输出部分的pid参数
#define DM_POS_PITCH_KP 25.0f
#define DM_POS_PITCH_KD 0.3f
...
//pitch轴物理限幅参数
#define PITCH_LIMIT_MAX 2.1f
#define PITCH_LIMIT_MIN 2.90f
