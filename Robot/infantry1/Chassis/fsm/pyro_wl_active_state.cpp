...
{
    static_cast<dm_motor_drv_t*>(owner->_ctx.motor.joint[leg_def::LEFT][motor_def::HIP])->clear_error();
    static_cast<dm_motor_drv_t*>(owner->_ctx.motor.joint[leg_def::LEFT][motor_def::KNEE])->clear_error();
